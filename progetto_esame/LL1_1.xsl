...
<!-- DESCRIZIONE DEL MANOSCRITTO DIV -->
    ...
    <xsl:template match="//tei:support">
        <ul>
            ...
            <!-- Filigrana -->
            <p>            
                <xsl:element name="a">              <!--  <a name="ID#LL1.1_hotspot_rv-01"> &nbsp;&nbsp;&nbsp;&nbsp; </a>    -->
                    <xsl:attribute name="name">     <!--  al posto di &nbsp; appare un quadratino rosso per indicare l'elemento che corrisponde alla zona della mappa dell'immagine della lettera -->
                        <xsl:value-of select="concat('ID',//tei:watermark/tei:p[1]/tei:hi/@facs)"/>
                    </xsl:attribute>
                    <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;&nbsp;&nbsp;&nbsp;]]></xsl:text>
                </xsl:element>
                <xsl:element name="a">
                    <xsl:attribute name="name">
                        <xsl:value-of select="concat('ID', //tei:watermark/tei:p[2]/tei:hi/@facs )"/>
                    </xsl:attribute>
                    <xsl:text disable-output-escaping="yes"><![CDATA[&nbsp;&nbsp;&nbsp;&nbsp;]]></xsl:text>
                </xsl:element>
...
<!-- IMMAGINI DEL MANOSCRITTO ORIGINALE DIV -->
    ...
    <xsl:template match="//tei:facsimile">
        <xsl:for-each select="tei:surface/tei:graphic"> 
            ...
            <xsl:element name="img">    <!-- <img usemap="#map1" id="imglettera1" src="LL1.1_fronte_recto.jpg" class="immagini_lettera"> -->
